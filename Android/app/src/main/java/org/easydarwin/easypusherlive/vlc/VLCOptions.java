...
import org.easydarwin.easypusherlive.MyApplication;
...
public class VLCOptions {
    ...
    public static ArrayList<String> getLibOptions(Context context) {
        ...
        final boolean timeStrechingDefault = MyApplication.getAppResources().getBoolean(R.bool.time_stretching_default);
