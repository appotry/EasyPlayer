...
static const CGFloat MenuViewHeight = 40;

@interface AmberContainerVC () <UIScrollViewDelegate, MenuMenuViewDelegate>

@property (nonatomic, assign) CGFloat topBarHeight;
@property (nonatomic, assign) NSInteger currentIndex;
@property (nonatomic, strong) AmberMenuView *menuView;

@end

@implementation AmberContainerVC
...
- (void)viewDidLoad {
    ...
    _contentScrollView.frame = CGRectMake(0,_topBarHeight + MenuViewHeight, self.view.frame.size.width, self.view.frame.size.height - (_topBarHeight + MenuViewHeight));
    ...
    // meunView
    _menuView = [[AmberMenuView alloc]initWithFrame:CGRectMake(0, _topBarHeight, self.view.frame.size.width, MenuViewHeight)];
